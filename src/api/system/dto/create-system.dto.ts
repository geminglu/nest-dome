 ...
 * 字段查询参数
 */
export class QueryBaseDictionaryDto extends IntersectionType(QueryLogInLog) {
  @ApiProperty({ title: '字典名称', required: true, maxLength: 36 })
  @IsOptional()
  @IsString()
  @MaxLength(36)
 ...
 * 字段查询参数
 */
export class QueryDictionaryDetailDto extends IntersectionType(PartialType(QueryLogInLog)) {
  @ApiProperty({ title: '字典编码', required: true, maxLength: 36 })
  @IsString()
  @MaxLength(36)
  code: string;
